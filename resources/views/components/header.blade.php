...
<header x-data="{ profileDropdownOpen: false, notificationsOpen: false }"
    ...
    <div class="flex items-center space-x-2 md:space-x-4">
        <div class="relative"><button @click="notificationsOpen = !notificationsOpen"
                class="relative text-slate-400 hover:text-red-500 p-2 rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors"><svg
            ...
            <div class="relative">
                ...
                <div x-show="profileDropdownOpen" @click.outside="profileDropdownOpen = false" x-transition
                    ...
                    <div class="py-1"><a href="#"
                            class="group flex items-center px-4 py-2 text-sm text-slate-200 hover:bg-gray-600 hover:text-red-500"><svg
