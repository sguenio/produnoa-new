...
@section('breadcrumbs')
    ...
    <li class="inline-flex items-center"><span class="mx-1 text-slate-500">/</span><span
            class="font-medium text-slate-200">Categorías</span></li>
@endsection
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-slate-100">Categorías de Productos</h1>
        {{-- El botón Crear solo es visible para el Administrador --}}
        ...
        <table class="datatable w-full text-sm">
            <thead>
                <tr>
                    ...
                    {{-- La columna Acciones solo es visible para el Administrador --}}
                    @if (Auth::user()->rol === 'Administrador')
                        ...
                        @if (Auth::user()->rol === 'Administrador')
                            <td class="text-center">
                                <div class="flex justify-center items-center space-x-2">
                                    ...
                                    <a href="{{ route('categorias.especificaciones.index', $categoria->id) }}"
