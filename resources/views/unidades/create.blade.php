...
@section('breadcrumbs')
    ...
    <li class="inline-flex items-center"><span class="mx-1 text-slate-500">/</span><span class="font-medium text-slate-200"
            aria-current="page">Crear</span></li>
@endsection
@section('content')
    <div class="p-4 sm:p-6 bg-gray-800 shadow-lg rounded-lg max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-slate-100 mb-6">Crear Nueva Unidad de Medida</h1>
        <form action="{{ route('unidades.store') }}" method="POST">
            ...
            <div class="mt-8 flex justify-end gap-4">
                ...
                <button type="submit"
                    class="py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700">Guardar</button>
            </div>
        </form>
    </div>
@endsection
