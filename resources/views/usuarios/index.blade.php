...
@section('breadcrumbs')
    ...
    <li class="inline-flex items-center">
        ...
        <span class="font-medium text-slate-200" aria-current="page">Usuarios</span>
    </li>
@endsection
...
@section('content')
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('usuarios.create') }}"
            class="w-full sm:w-auto bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg flex items-center justify-center transition-colors duration-150 cursor-pointer">
    ...
    <div class="p-4 sm:p-6 bg-gray-800 shadow-lg rounded-lg">
        <table id="usersTable" class="datatable w-full text-sm">
            <thead>
                <tr>
                    <th>ID</th>
                ...
                @foreach ($usuarios as $usuario)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <span
                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-sky-200 text-sky-800">
                                    Operario
                                </span>
                            @endif
                        </td>
