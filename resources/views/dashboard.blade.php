...
@section('content')
    ...
    <div class="mt-8">
        <div class="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
            <h2 class="text-xl font-semibold text-slate-200">Tabla de Ejemplo</h2>
            <button
        ...
        {{-- ESTE DIV ES LA SOLUCIÓN AL SCROLL HORIZONTAL --}}
        <div class="overflow-x-auto bg-gray-800 shadow-lg rounded-lg p-4">
...
{{-- El push de scripts no cambia --}}
@push('scripts')
    <script>
        $(function() {
            new DataTable('#productsDataTable', {
                /* ... */ });
        });
    </script>
@endpush
