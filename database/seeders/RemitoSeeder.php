...
class RemitoSeeder extends Seeder
{
    ...
    {
        // Obtenemos los IDs de los proveedores que ya existen para asignarlos aleatoriamente
        $proveedorIds = Proveedor::pluck('id')->toArray();

        if (empty($proveedorIds)) {
            $this->command->warn('No se encontraron proveedores. Por favor, ejecuta primero el ProveedorSeeder.');
            return;
        }
        ...
        $remitos = [
            ...
            ['codigo_remito' => 'A-001-00345', 'fecha_recepcion' => '2025-07-11', 'observaciones' => 'Revisar estado de los envases.'],
            ...
            ['codigo_remito' => 'R-006115', 'fecha_recepcion' => '2025-07-13', 'observaciones' => 'Control de temperatura OK.'],
            ['codigo_remito' => 'R-006130', 'fecha_recepcion' => '2025-07-14', 'observaciones' => null],
        ...
        foreach ($remitos as $remito) {
            Remito::create([
                'proveedor_id' => $proveedorIds[array_rand($proveedorIds)], // Asigna un proveedor aleatorio
